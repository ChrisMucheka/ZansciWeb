...
<div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">Case studies</h1>
            <hr class="hr-light">
...
<section id="offers" class="text-center grey lighten-4 " style="padding-top: 2.5%;padding-bottom:  2.5%;">
<div class="container-fluid">
<div class="row d-flex justify-content-center mb-4">
<div class="col-md-12 mb-12 ">
    <h3 class="mb-4 font-weight  d-flex justify-content-center "><strong>Next:</strong> How does the Studiosity service work?</h3>
<div class="container-fluid">
<div class="col-md-6 offset-md-3 mb-6">
   <button type="button" class="btn btn-info btn-md" >Read more</button>
</div>
