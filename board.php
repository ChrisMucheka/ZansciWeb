...
<div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">Our Board of Directors</h1>
            <hr class="hr-light">
          <h4 class="font-bold white-text mb-2">Strategic leadership, combining business growth with social mission.</h4>
          </div>
          <!--Grid column-->
        </div>
        <!--Grid row-->
...
<div class="col-md-3 mb-3 gray">
    ...
    <div class="col-md-3 mb-3 gray">
     <img src="img/Studiosity-Team-250x250-JillMcGuire.webp" style="width:100%;"/>
    <h6><strong>Jill McGuire</strong></h6>
    <h6>Director, Education & Academic Operations</h6>
    <p>Jack has been an educational technology visionary and entrepreneur for more than two decades, both overseas and in Australia. He founded Studiosity 14 years ago, with a vision to make the highest quality academic study support accessible to every student, regardless of their geographic or socio-economic circumstances. As an active volunteer for education-related organisations, he mentors EduGrowth's edtech start-ups, and is the president of Friends of Libraries</p>
</div>
</div>
</div>
...
<section id="video" class="text-center gray">
<div class="container-fluid">
<div class="row">
<div class="col-md-12 mb-12">
    <h3 class="mb-4 font-weight  d-flex justify-content-center " style="padding-top: 2.5%;"><q>This is a company that cares about quality, and cares about academic integrity.</q></h3>
    <p>What drives the organisation to achieve more?</p>
    ...
    <div class="container">
      ...
      <div class="row py-4 d-flex align-items-center">
        ...
        <div class="col-md-6 col-lg-7 text-center text-md-right">
          <!-- Facebook -->
          <a class="fb-ic">
            <i class="fab fa-facebook-f white-text mr-4"> </i></a>
          <!-- Twitter -->
          <a class="tw-ic">
            <i class="fab fa-twitter white-text mr-4"> </i></a>
          <!-- Google +-->
          <a class="gplus-ic">
            <i class="fab fa-google-plus-g white-text mr-4"></i></a>
          <!--Linkedin -->
          <a class="li-ic">
            <i class="fab fa-linkedin-in white-text mr-4"></i></a>
          <!--Instagram-->
          <a class="ins-ic">
            <i class="fab fa-instagram white-text"></i></a>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row-->
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3 dark-grey-text">
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p><a class="dark-grey-text" href="#!">Calendars and Organizers</a></p>
        <p><a class="dark-grey-text" href="#!">Study survival guides</a></p>
        <p><a class="dark-grey-text" href="#!">Student FAQs</a></p></div>
      <!-- Grid column -->
      <!-- Grid column -->
