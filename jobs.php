...
<div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">Great results come from great people</h1>
          </div>
          <!--Grid column-->
        </div>
        <!--Grid row-->
...
<div class="col-md-12 mb-12" style="padding-top: 2.5%;padding-bottom:2.5%;">
     <h3>Want to become one of our Subject Specialists?</h3>
          <p class="col-md-10 offset-md-1 mb-10">The incredible people in our online network who help students are amongst the best at what they do. Even then, they must also pass through our stringent accreditation process. The result is a flexible, engaging employment experience, supporting a worthy education mission.</p>
    <div class="col-md-6 offset-md-3 mb-6 grey lighten-5" style="padding: 15px;" >
<form class="border border-light p-4">
    <h5 class="text-left"><strong>Expression of interest:</strong></h5>
    <label for="defaultContactForm">First name*</label>
...
<label class="">Expression of interest*</label>
    <textarea class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3" placeholder="Please outline your qualifications and reasons for applying"></textarea>
