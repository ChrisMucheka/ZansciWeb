...
<div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">The Zansci Story</h1>
            <hr class="hr-light">
...
<div class="col-md-12 mb-12">
    <h3 class="mb-4 font-weight  d-flex justify-content-center " style="padding-top: 2.5%;">Why we do what we do:</h3>
