...
<div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">Subjects</h1>
            <hr class="hr-light">
          <h4 class="font-bold white-text mb-2">For core skills, we've got you covered from Accounting to Zoology.</h4>
          </div>
          <!--Grid column-->
        </div>
        <!--Grid row-->
...
<div class="col-md-12 mb-12" style="padding-top:2.5%;">
    <h2 class="mb-4 text-left">Writing Feedback:</h2>
<div class="container-fluid">
<div class="row d-flex justify-content-center mb-4">
<div class="col-md-2 mb-2">
    <h6 class="text-left"><strong>Availability:</strong></h6>
    <p class="text-left">365 days a year</p>
    <p class="text-left">24hrs a day</p>
</div>
    <div class="col-md-8 mb-8">
    <h6 class="text-left"><strong>Description</strong></h6>
    <p class="text-left">Review of written assessment drafts (500+ words) for academic literacy, including structure, spelling, grammar, punctuation and referencing using our bespoke platform with inbuilt tools. CVs, Resumes and cover letters are also accepted for feedback on spelling and grammar, general structure and readability. Files returned in less than 24 hours.
No review of curricula-based content, no editing or proofreading.
Return times may be delayed during public holiday periods.
</p>
</div>
</div>
</div>
...
<div class="col-md-12 mb-12" >
    <h2 class="mb-4 text-left">Live subjects:</h2>
<div class="container-fluid">
<div class="row d-flex justify-content-center mb-4">
<div class="col-md-2 mb-2">
    <h6 class="text-left"><strong>Availability:</strong></h6>
    ...
    <div class="col-md-8 mb-8">
    <h6 class="text-left"><strong>Description</strong></h6>
    <p class="text-left">Support for core English skills and concepts from all school levels through to tertiary bridging/ access/ foundation levels including: core skills (punctuation, grammar, structure); essay and report writing; creative writing; speeches and generic text analysis.
...
<section id="enquiry" class="text-center" >
    <div class="container-fluid col-md-12 mb-12" style="background: url(img/bg.jpeg);-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;
  background-size: cover;background-repeat:no-repeat;padding-bottom:5%;padding-top:5%;" >
...
<div class="row d-flex justify-content-center mb-4">
<div class="col-md-12 mb-12 ">
    <h3 class="mb-4 font-weight  d-flex justify-content-center " style="padding-top: 2.5%;"><strong>Next:</strong> How does the Studiosity service work?</h3>
<div class="container-fluid">
