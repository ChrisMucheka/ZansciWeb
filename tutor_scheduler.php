...
<div class="col-md-4 mb-4" style="padding-top:2.5%;">
    <iframe src="https://calendar.google.com/calendar/embed?src=6tlq6rlnqs05q3e1lskjdqah4k%40group.calendar.google.com&ctz=Africa%2FJohannesburg" style="border: 0; width:100%; height:150%;" frameborder="0" scrolling="no"></iframe>
</div>

<div class="col-md-8 mb-8" style="padding-top:2.5%;">
    <p class="text-center" style="line-height:10px;">31/05/2020 - 06/06/2020</p>
<p class="text-center" style="line-height:10px;">Hours scheduled: 0</p>
<p class="text-center" style="line-height:10px;">Maximum allowed: 10</p>
<p class="text-center" style="line-height:10px;">Time: 02/06/2020 1:19:23 PM (Sydney)</p>
<p class="text-center" style="line-height:10px;">Scheduler timezone (below): Africa/Johannesburg (GMT+02:00)</p>
</div>
</div>
</div>
</div>
