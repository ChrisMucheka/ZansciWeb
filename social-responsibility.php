...
<head>
  ...
  <title>
Social responsibility | Zansci</title>
  <!-- MDB icon -->
...
<div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">Social responsibility</h1>
            <hr class="hr-light">
          <h4 class="font-bold white-text mb-2">At the very core of our mission; it's why we're here.</h4>
          </div>
          <!--Grid column-->
        </div>
        <!--Grid row-->
...
<div class="row row-cols-1 row-cols-md-3">
  <div class="col mb-4">
    ...
    <div class="card gray">
      ...
      <div class="card-body">
        <!--Title-->
        <h4 class="card-title text-center">Message from our Founder & Chair</h4>
        <!--Text-->
        <p class="card-text text-center"> >> Foreword from our Founder and Chair, Jack Goodman</p>
  ...
  <div class="col mb-4">
    ...
    <div class="card gray">
      ...
      <div class="card-body">
        <!--Title-->
        <h4 class="card-title text-center">Message from our CEO</h4>
        <!--Text-->
        <p class="card-text text-center"> >> Foreword from our CEO, Michael Larsen</p>
        <!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
        <div class="container-fluid">
        <div class="col-md-6 offset-md-3 mb-6">
        <button type="button" class="btn btn-info btn-md" >Read more</button>
  ...
  <div class="col mb-4">
    ...
    <div class="card gray">
      ...
      <div class="card-body">
        <!--Title-->
        <h4 class="card-title text-center">Social Responsibility Policy</h4>
        <!--Text-->
        <p class="card-text text-center"> >> Social responsibility policy document (pdf, 1.3 MB)</p>
        <!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
        <div class="container-fluid">
        <div class="col-md-6 offset-md-3 mb-6">
        <button type="button" class="btn btn-info btn-md" >Download</button>
        </div>
        </div>
      </div>
    </div>
