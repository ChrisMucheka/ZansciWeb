 ...
 <div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">The Studiosity Story</h1>
            <hr class="hr-light">
          <h4 class="font-bold white-text mb-2">Because education can change the world.</h4>
          </div>
          <!--Grid column-->
        </div>
        <!--Grid row-->
...
<section id="offers" class="text-center gray">
...
<div class="col-md-6 mb-6">
    <h3 class="mb-4 font-weight  d-flex justify-content-center " style="padding-top: 2.5%;"><strong><q>Who are your Subject Specialists?</q></strong></h3>
<p>Real people held to the highest standards. Not only are they the best and brightest minds, they must also go through our strict accreditation process and continually maintain our education and integrity standards in order to keep their coveted place in the network.</p>
    <div class="container-fluid">
      <div class="col-md-6 offset-md-3 mb-6">
        <button type="button" class="btn btn-info btn-md" >Meet our Subject Specialists </button>
      </div>
    </div>
</div>
</div>
...
<div class="row d-flex justify-content-center mb-4">
<div class="col-md-6 mb-6">
    <h3 class="mb-4 font-weight  d-flex justify-content-center " style="padding-top: 2.5%;"><strong><q>Who can access Studiosity?</q></strong></h3>
<p>Our partners are education institutions - Universities, schools, and government. This means students can access Studiosity for free as part of their enrolment. Students not at a partner institution can open their own account..</p>
        <div class="container-fluid">
        <div class="col-md-6 offset-md-3 mb-6">
        <button type="button" class="btn btn-info btn-md" >Meet our Subject Specialists </button>
        </div>
...
<div class="col-md-12 mb-12" style="padding-top:2.5%;">
    <h2 class="mb-4">Just some of the team</h2>
<div class="container">
<div class="row d-flex justify-content-center mb-4">
