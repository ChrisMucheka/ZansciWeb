...
<head>
  ...
  <title>
Video Library - Your library of Zansci stories</title>
  <!-- MDB icon -->
...
<div class="card card-intro blue-gradient">
      <div class="card-body white-text black text-center">
        ...
        <div class="row d-flex justify-content-center">
          <!--Grid column-->
          <div class="col-md-9">
          <h1 class="font-bold white-text mb-2">Video-Sci</h1>
            <hr class="hr-light">
          <h4 class="font-bold white-text mb-2">Stories from inside Zansci and from our partners in education.</h4>
          </div>
          <!--Grid column-->
        </div>
        <!--Grid row-->
...
<div class="row row-cols-1 row-cols-md-3">
  ...
  <iframe class="embed-responsive-item" src="https://player.vimeo.com/video/352637727" allowfullscreen></iframe>
</div>
      <!--Card content-->
      <div class="card-body">
        <!--Title-->
...
<div class="container">
<h2 class="mb-4">Just a few of our partners: </h2>
<div class="row">
