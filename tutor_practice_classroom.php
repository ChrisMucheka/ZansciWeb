...
<div class="row d-flex justify-content-center mb-4" style="padding-top:2.5%">
  <div class="col-md-12 col-md-12 text-center"><h1>Practice Classroom</h1></div>
...
<!-- Grid column -->
  <div class="col-md-4 col-md-4 justify-content-left">
    <!--Card Primary-->
    <div class="card text-center z-depth-2">
      <div class="card-body">
<button type="button" class="btn btn-curved btn-rounded" >Make me available</button>
        <p class="black-text mb-0" style="font-size:200%">Disconnected</p>
      </div>
    </div>
    <!--/.Card Primary-->
...
<!-- Grid column -->
  <div class="col-md-6 offset-md-1 col-md-6">
    <!--Card Primary-->
    <div class="card text-center z-depth-2">
      <div class="card-body">
        <h3 class="text-uppercase font-weight-bold black-text mt-2 mb-3"><strong>Skillset Availability</strong></h3>
<div class="row d-flex justify-content-center mb-12" >
<div class="col-md-3 col-md-3">
        <h6 class="black-text mb-0" ><i class="far fa-smile ml-3" style="color:orange" ></i> Maths 7-10 </h6>
</div>
<div class="col-md-3 col-md-3">
        <h6 class="black-text mb-0" ><i class="far fa-smile ml-3" style="color:red" ></i> Biolog </h6>
</div>
<div class="col-md-3 col-md-3">
        <h6 class="black-text mb-0" ><i class="far fa-smile ml-3" style="color:red" ></i> Chemistry </h6>
</div>
</div>
      </div>
    </div>
...
<div class="container gray" style="padding-bottom:2.5%;">
<div class="row d-flex justify-content-right mb-4" >
<!-- Grid column -->
  <div class="col-md-5 offset-md-6 col-md-5 justify-content-left">
    <!--Card Primary-->
    <div class="card  text-center z-depth-2">
      <div class="card-body">
            <div class="row d-flex justify-content-left mb-12" >
<div class="col-md-4 col-md-3">
        <h6 class="black-text mb-0" ><i class="far fa-smile ml-3" style="color:orange" ></i> Very busy </h6>
</div>
<div class="col-md-3 col-md-3">
        <h6 class="black-text mb-0" ><i class="far fa-smile ml-3" style="color:red" ></i> Busy </h6>
</div>
<div class="col-md-5 col-md-3 ">
        <h6 class="black-text mb-0" ><i class="far fa-smile ml-3" style="color:red" ></i> Demand met </h6>
</div>
</div>
      </div>
    </div>
